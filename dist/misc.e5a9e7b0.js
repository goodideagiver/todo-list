...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/script/misc.js":[function(require,module,exports) {
var themeSwitcher = document.querySelector('#switchTheme');

var disableEditMode = function disableEditMode() {
  var editModeButtons = document.querySelectorAll('.edit-mode-buttons');

  if (editModeButtons) {
    editModeButtons.forEach(function (element) {
...
var saveChanges = function saveChanges() {
  disableEditMode();
  var lists = [];
  mainListNodeContainer.childNodes.forEach(function (list) {
    var listObj = {
...
var addElementsToContainer = function addElementsToContainer(container, elementsArray) {
  elementsArray.forEach(function (element) {
    container.appendChild(element);
  });
};

var clickElementOnEnterPress = function clickElementOnEnterPress(element, elementToPress) {
...
var createCustomNode = function createCustomNode(elementType, object) {
...
var setThemeOnLaunch = function setThemeOnLaunch() {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/script/misc.js"], null)
//# sourceMappingURL=/misc.e5a9e7b0.js.map